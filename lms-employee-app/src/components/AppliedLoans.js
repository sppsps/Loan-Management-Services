      ...
      <div className="container-fluid">
        ...
        <div className="row">
          {loancards && loancards.map(loancard => (
            <div className="col-md-4" key={loancard[0]}>
              {/* <LoanCard
          ...
          className="card-img-top" alt={"image"} /> */}
                <img src={(loancard[1] === "Furniture") ? '../images/furniture.jpg' : ((loancard[1] === "Crockery") ? '../images/crockery.jpg' : (loancard[1] === "Automobile") ? '../images/automobile.jpg' : (loancard[1] === "Medical") ? '../images/medical.jpg' : (loancard[1] === "Ornaments") ? '../images/jewellery.jpg' : '../images/payday.jpg')}
                ...
                <div className="card-body">
                  <h5 className="card-title">{loancard[1]}</h5>
                  <p className="card-text">Duration : {loancard[2]} Years</p>
